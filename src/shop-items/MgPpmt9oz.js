...
export default class MgPpmt9oz extends React.Component {
  render() {
    return (
      <div className="product-box">
        <div>
          ...
          <img className="product-img" src={nine_ppmt} alt="ppmt_9" />
          <p>$41.99</p>
          <button
            type="button"
            className="btn"
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p>
                  ...
                  Spectrum Cannabidiol Extract, Peppermint Essential Oil Blend.
                </p>
