...
export default class MgVan9oz extends React.Component {
  render() {
    return (
      <div className="product-box">
        <div>
          ...
          <img className="product-img" src={nine_vanilla} alt="van_9" />
          <p>$41.99</p>
          <button
            type="button"
            className="btn"
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p>
                  ...
                  Spectrum Cannabidiol Extract, Vanilla Essential Oil Blend.
                </p>
